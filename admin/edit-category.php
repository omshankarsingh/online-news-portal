...
else
{
    if(isset($_POST['submit']))
    {
        ...
        $query=mysqli_query($con,"Update  categories set CategoryName='$category',Description='$description' where id='$catid'");
        if($query)
        {
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                ...
                                <?php 
                                $catid=intval($_GET['cid']);
                                $query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from categories where Is_Active=1 and id='$catid'");
                                $cnt=1;
