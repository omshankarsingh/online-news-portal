...
else
{
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            $status=1;
            $query=mysqli_query($con,"insert into posts(PostTitle,CategoryId,SubCategoryId,PostDetails,PostUrl,Is_Active,PostImage) values('$posttitle','$catid','$subcatid','$postdetails','$url','$status','$imgnewfile')");
            if($query)
            {
