    ...
    <div class="container">
        <div class="row" style="margin-top: 4%">
            <div class="col-md-8">
                ...
                $query=mysqli_query($con,"select posts.id as pid,posts.PostTitle as posttitle,categories.CategoryName as category,posts.PostDetails as postdetails,posts.PostingDate as postingdate,posts.PostUrl as url from posts left join categories on categories.id=posts.CategoryId where posts.PostTitle like '%$st%' and posts.Is_Active=1 LIMIT $offset, $no_of_records_per_page");
